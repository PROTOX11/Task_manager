  ...
  return (
    <Button
      ...
      className={cn(
        ...
        showLabel
          ? "h-11 min-w-[8.5rem] gap-3 rounded-full px-4 py-2.5"
          : "h-10 w-10 rounded-full p-0 sm:h-10 sm:w-10",
    ...
    >
      ...
      <span className="relative z-10 flex items-center gap-2">
        <span className="relative flex h-[26px] w-[26px] items-center justify-center rounded-full bg-[linear-gradient(145deg,rgba(255,255,255,0.82),rgba(244,226,204,0.92))] shadow-[0_8px_20px_rgba(120,88,54,0.18)] ring-1 ring-white/60 transition-transform duration-300 ease-out dark:bg-[linear-gradient(145deg,rgba(138,94,54,0.45),rgba(83,56,33,0.7))] dark:ring-white/10 sm:h-[30px] sm:w-[30px]">
          <SunMedium className="absolute h-[15px] w-[15px] scale-100 rotate-0 text-amber-800 transition-all duration-500 ease-in-out dark:scale-0 dark:-rotate-90 sm:h-[17px] sm:w-[17px]" />
          <MoonStar className="absolute h-[15px] w-[15px] scale-0 rotate-90 text-amber-100 transition-all duration-500 ease-in-out dark:scale-100 dark:rotate-0 sm:h-[17px] sm:w-[17px]" />
        </span>
        {showLabel && (
          <span className="flex flex-col items-start leading-none">
            <span className="text-[10px] uppercase tracking-[0.28em] text-foreground/60">
              Theme
            </span>
