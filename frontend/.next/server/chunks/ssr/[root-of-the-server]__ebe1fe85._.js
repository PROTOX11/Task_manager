...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const bootstrap = async ()=>{
            const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getToken"])();
            if (!token) {
                setIsLoading(false);
                return;
            }
            try {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/profile");
                setUser(mapApiUser(response.user));
            } catch  {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearToken"])();
                setUser(null);
            } finally{
                setIsLoading(false);
            }
    ...
    const login = async (email, password)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/login", {
            method: "POST",
            body: JSON.stringify({
                email,
                password
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setToken"])(response.token);
        setUser(mapApiUser(response.user));
    };
    const authenticateWithGoogle = async (credential)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/google", {
            method: "POST",
            body: JSON.stringify({
                credential
            }),
    ...
    const signup = async (data)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/signup", {
            method: "POST",
            body: JSON.stringify({
    ...
    const requestSignupOtp = async (email)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/signup/send-otp", {
            method: "POST",
            body: JSON.stringify({
                email
            }),
    ...
    const verifySignupEmailOtp = async (email, otp)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/signup/verify-email-otp", {
            method: "POST",
            body: JSON.stringify({
                email,
                otp
    ...
    const verifySignupOtp = async (data)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/signup/verify-otp", {
            method: "POST",
            body: JSON.stringify({
                name: `${data.firstName} ${data.lastName}`.trim(),
                email: data.email,
    ...
    const completeVerifiedSignup = async (data)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/signup/complete-verified", {
            method: "POST",
            body: JSON.stringify({
                name: `${data.firstName} ${data.lastName}`.trim(),
                email: data.email,
    ...
    const signupAdmin = async (data)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/signup/admin", {
            method: "POST",
            body: JSON.stringify({
                name: `${data.firstName} ${data.lastName}`.trim(),
                email: data.email,
...
function DataProvider({ children }) {
    ...
    const loadProjects = async ()=>{
        if (!user) return;
        const projectResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/projects");
        const normalizedProjects = await Promise.all(projectResponse.projects.map(async (apiProject)=>{
            ...
            const [panelResponse, taskResponse] = await Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/panels/project/${projectId}`),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/tasks/project/${projectId}`)
            ]);
            const tasksByPanel = {};
    ...
    const loadRequests = async ()=>{
        if (!user) return;
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/requests/history");
    ...
    const createProject = async (data)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/projects", {
            method: "POST",
            body: JSON.stringify({
                name: data.name,
    ...
    const updateProject = async (id, data)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/projects/${id}`, {
            method: "PUT",
            body: JSON.stringify({
                name: data.name,
                description: data.description,
    ...
    const addPanel = async (projectId, name)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/panels", {
            method: "POST",
            body: JSON.stringify({
                name,
                projectId
    ...
    const updatePanel = async (_projectId, panelId, name)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/panels/${panelId}`, {
            method: "PUT",
            body: JSON.stringify({
                name
            })
    ...
    const createTask = async (data)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/tasks", {
            method: "POST",
            body: JSON.stringify({
                title: data.title,
                description: data.description,
    ...
    const updateTask = async (taskId, data)=>{
        ...
        if (Object.keys(payload).length === 1 && payload.status) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/tasks/${taskId}/status`, {
                method: "PATCH",
                body: JSON.stringify({
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/tasks/${taskId}`, {
                method: "PUT",
    ...
    const sendInvitation = async (projectId, email, message)=>{
        ...
        if (!project) return;
        const usersResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/users");
        const developer = (usersResponse.users || []).find((u)=>u.email === email);
        if (!developer) throw new Error("Developer not found");
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/projects/${projectId}/invite`, {
            method: "POST",
            body: JSON.stringify({
    ...
    const respondToRequest = async (requestId, accept)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/requests/${requestId}/${accept ? "accept" : "reject"}`, {
            method: "PUT"
        });
        await Promise.all([
            loadProjects(),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ebe1fe85._.js.map