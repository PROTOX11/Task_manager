...
function AuthProvider(param) {
    ...
    const authenticateWithGoogle = async (credential)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/google", {
            method: "POST",
            body: JSON.stringify({
                credential
            }),
    ...
    const requestSignupOtp = async (email)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/signup/send-otp", {
            method: "POST",
            body: JSON.stringify({
                email
            }),
    ...
    const verifySignupEmailOtp = async (email, otp)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/signup/verify-email-otp", {
            method: "POST",
            body: JSON.stringify({
                email,
                otp
    ...
    const verifySignupOtp = async (data)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/signup/verify-otp", {
            method: "POST",
            body: JSON.stringify({
                name: "".concat(data.firstName, " ").concat(data.lastName).trim(),
                email: data.email,
    ...
    const completeVerifiedSignup = async (data)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/signup/complete-verified", {
            method: "POST",
            body: JSON.stringify({
                name: "".concat(data.firstName, " ").concat(data.lastName).trim(),
                email: data.email,
